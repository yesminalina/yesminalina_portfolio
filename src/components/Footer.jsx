...
const Footer = () => {
  ...
  return (
    <footer className='flex justify-center text-olive p-4 text-xs font-medium w-full'>
      <article className='flex justify-center w-full border-t pt-2 md:mx-24'>
        <p className='m-0 self-center'>Built with Reactjs and Tailwind CSS by Yesminalina - 2026 </p>
