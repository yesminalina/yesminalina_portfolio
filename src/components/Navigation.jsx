...
const Navigation = () => {
  ...
  return (
    <nav className={`flex flex-col justify-center align-middle w-full py-6 sm:py-10 font-semibold px-6 sm:px-40 top-0 inset-x-0 z-50 fixed backdrop-blur-md sm:h-16 transition-colors duration-150 ${isDarkSection ? 'text-yellow_pale' : 'text-olive'}`}>
